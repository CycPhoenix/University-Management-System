...
def update_student_records():
    ...
    | | | ___  _| | ___ _| |_ ___  / __> _| |_ _ _  _| | ___ ._ _ _| |_  | . \ ___  ___  ___  _ _  _| | ___
    | ' || . \/ . |<_> | | | / ._> \__ \  | | | | |/ . |/ ._>| ' | | |   |   // ._>/ | '/ . \| '_>/ . |<_-<
    `___'|  _/\___|<___| |_| \___. <___/  |_| `___|\___|\___.|_|_| |_|   |_\_\\___.\_|_.\___/|_|  \___|/__/
         |_|                                                                                               
    """
    separator_length = max(len(line) for line in usr_art.splitlines())
    ...
    for line in students:
        ...
        if student_data[0] == student_id:
            ...
            # Update Name
            new_name = input(f"Enter new Student Name (press Enter to keep current): ").strip() or student_data[1]
            if not new_name:
            ...
            try:
                ...
                while True:
                    ...
                    if not department_choice: # Keep current department
            ...
            if new_department in ["Foundation", "Diploma"]:
                ...
                try:
                    ...
                    while True:
                        ...
                        if not program_choice: # Keep current program
            ...
            if new_department in ["Undergraduate", "Postgraduate"]:
                ...
                try:
                    ...
                    while True:
                        category_choice = input("Select a category (or press Enter to keep current): ").strip()
                        if not category_choice: # Keep current program
                            new_program = student_data[3]
                            break
            ...
            if not new_contact_number:
                new_contact_number = student_data[5]
